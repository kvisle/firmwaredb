...
# BIOS HP ProLiant BL465c G7 A19
wget 'http://h20566.www2.hp.com/portal/site/hpsc/template.PAGE/public/psi/swdDetails/?sp4ts.oid=4132827&spf_p.tpst=swdMain&spf_p.prp_swdMain=wsrp-navigationalState%3Didx%253D%257CswItem%253DMTX_22d93680d455447f94be9c7636%257CswEnvOID%253D54%257CitemLocale%253D%257CswLang%253D%257Cmode%253D5%257Caction%253DdriverDocument&javax.portlet.begCacheTok=com.vignette.cachetoken&javax.portlet.endCacheTok=com.vignette.cachetoken' -O - -o /dev/null | perl hpbios A19 > out.d/hp_proliant_bl465c_g7_a19.csv
